$ConfigurationFile = Join-Path -Path $PSScriptRoot -ChildPath 'Demo 1 - Configuration.psm1'
$ConfigDataFile    = Join-Path -Path $PSScriptRoot -ChildPath 'Demo 1 - ConfigData.psd1'
